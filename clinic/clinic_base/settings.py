...
SECRET_KEY = 'django-insecure-gmk67e56c_qevp94%gfn^v8h)&4-y@))dcw!li_!+oiu%$l4ft'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sincreaser4@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'fzxp szkw gkiy uzcv'  # See instructions below